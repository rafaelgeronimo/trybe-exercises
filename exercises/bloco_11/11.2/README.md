...
Para realizar esse exercício, crie um arquivo chamado `data.js` no diretório `.src/` do projeto que voc6e acabou de criar. Copie para esse arquivo o seguinte conteúdo:
```javascript
const pokemons = [
  {
      id: 25,
...
1. `Pokemon`: como o próprio nome diz, esse componente representa um pokemon. Esse componente recebe como entrada um objeto que contém informações referentes a um pokemon específico. Esse componente precisa retornar as seguintes informações obrigatórias para serem mostradas para quem usar a aplicação, essas informações devem ser validadas utilizando PropTypes:
    ...
    - imagem do pokemon.
2. `Pokedex`: esse componente representa a enciclopédia de pokemon. Esse componente recebe como entrada uma lista de pokemon para serem mostrados na tela.
Para cada um desses pokemon recebidos, `Pokedex` chama o componente `Pokemon`.

Segue uma sugestão de implementação da aplicação:

![https://course.betrybe.com//front-end/react/components/my-pokedex-project.gif](https://course.betrybe.com//front-end/react/components/my-pokedex-project.gif)
